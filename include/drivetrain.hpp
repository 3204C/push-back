 ...
 * 
 * @param cur_x, cur_y Current robot location.
 ...
 * 
 * @param left_voltage The voltage of each motor on the left side of the
 *                     drivetrain.
 * @param right_voltage The voltage of each motor on the right side of the
 *                      drivetrain.
...
/**
 * Controls the drivetrain motors using voltage for an amount of time. Used for
 * autonomous.
 * 
 * @param left_voltage The voltage of each motor on the left side of the
 *                     drivetrain.
 ...
 * 
 * @param angle The angular displacement from the robot's original orientation
 *              (in degrees).
 ...
 *                    commands or allow immediate execution.
 */
void dt_turn(double cur_x, double cur_y, double cur_heading, double x, double y, int duration, bool is_blocking);
 ...
 * @param end_distance The distance the robot stops at before reaching the point
 *                     (in inches).
 * @param is_blocking Determines whether the command will block subsequent
 *                    commands or allow immediate execution.
 */
void dt_move_straight(double cur_x, double cur_y, double cur_heading, double x, double y, int turn_duration, int move_duration,
